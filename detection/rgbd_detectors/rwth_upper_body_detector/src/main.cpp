...
int main(int argc, char **argv)
{
    ...
    // Printing debug info:
    ROS_DEBUG("**************************************************");
    ROS_DEBUG("Subscriptions: ");
    ROS_DEBUG("\t- topic_depth_image: [%s]", topic_depth_image.c_str());
    ROS_DEBUG("\t- topic_camera_info: [%s]", topic_camera_info.c_str());    
    ROS_DEBUG("\t- topic_gp: [%s]", topic_gp.c_str());
    ROS_DEBUG("\t- topic_color_image: [%s]", topic_color_image.c_str());

    ROS_DEBUG("Publications: ");
    ROS_DEBUG("\t- pub_markers_topic: [%s]", pub_markers_topic.c_str());        
    ROS_DEBUG("\t- pub_topic_closest: [%s]", pub_topic_closest.c_str());    
    ROS_DEBUG("\t- pub_topic_roi: [%s]", pub_topic_roi.c_str());    
    ROS_DEBUG("\t- pub_topic_ubd: [%s]", pub_topic_ubd.c_str());    
    ROS_DEBUG("\t- pub_topic_centres: [%s]", pub_topic_centres.c_str());
    ROS_DEBUG("\t- pub_topic_result_image: [%s]", pub_topic_result_image.c_str());
    ROS_DEBUG("\t- pub_topic_detected_persons: [%s]", pub_topic_detected_persons.c_str());
    ROS_DEBUG("**************************************************");
